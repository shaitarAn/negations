...
def write_files(data):
    ...
    outfile1 = outpath / Path('SHERLOCK_1label.json')
    textfile1 = outpath / Path('SHERLOCK_1label_noMORPHOwc_sents.txt')
    textfile2 = outpath / Path('SHERLOCK_1label_anno.txt')
...
zipped_data = [item for item in zipped_data if 0 not in item[1]]
