...
def iter_sentences(infile):
    ...
    for sentence in tree.findall('.//sentence'):
        ...
        negs_all = [elem for elem in sentence.iter() if elem.tag ==
                    "neg_structure" and elem.attrib['value'] != 'noneg']
...
def write_files(data):
    ...
    outfile1 = outpath / Path('spanishALL_1label_noNONEG.json')
    textfile1 = outpath / Path('spanishALLsents_noNONEG.txt')
    textfile2 = outpath / Path('spanishALLsents_1label_noNONEG_anno.txt')
